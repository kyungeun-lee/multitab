...
class Method(object, metaclass=abc.ABCMeta):
    def __init__(self, params, tasktype, input_dim=0, output_dim=0, device='cuda', data_id=None, modelname="modernnca"):
        """
    ...
    # def fit(self, X_train, y_train, X_val, y_val, info, train = True, config = None):
        """
        ...
        self.optimizer = torch.optim.AdamW(
            ...
            lr=self.args.config['lr'], 
            weight_decay=self.args.config['weight_decay']
        )
